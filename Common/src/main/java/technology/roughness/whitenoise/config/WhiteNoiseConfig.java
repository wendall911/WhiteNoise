...
public class WhiteNoiseConfig {
    ...
    private final List<Consumer<WhiteNoiseConfig>> loadListeners = new ArrayList<>();
    private final List<Consumer<WhiteNoiseConfig>> reloadListeners = new ArrayList<>();
    ...
    void setConfigData(InstanceType type, @NotNull final CommentedConfig configData, boolean create) {
    ...
    public void addLoadListener(Consumer<WhiteNoiseConfig> listener) {
        this.loadListeners.add(listener);
    }

    public void addReloadListener(Consumer<WhiteNoiseConfig> listener) {
        this.reloadListeners.add(listener);
    }

    public void fireLoad() {
        for (Consumer<WhiteNoiseConfig> loadListener : this.loadListeners) {
            loadListener.accept(this);
        }
    }

    public void fireReload() {
        for (Consumer<WhiteNoiseConfig> reloadListener : this.reloadListeners) {
