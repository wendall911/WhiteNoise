...
public class PrettyPrinter {
    ...
    public static String format(String unformattedString) {
        ...
        unformattedString = unformattedString.replaceAll(", customName=Optional.empty", "");
        ...
        unformattedString = unformattedString.replaceAll("UseRemainder", "");
        unformattedString = unformattedString.replaceAll("PotionContents", "");
        unformattedString = unformattedString.replaceAll("Enchantable", "");
        unformattedString = unformattedString.replaceAll("DamageResistant", "");
        unformattedString = unformattedString.replaceAll("DeathProtection", "");
        unformattedString = unformattedString.replaceAll("convertInto=", "");
